...
main <- function() {
  ...
  p_value_threshold <- ifelse(is.na(study_metadata$p_value_threshold) || is.null(study_metadata$p_value_threshold), lowest_p_value_threshold, study_metadata$p_value_threshold)
