...
exons_out <- mane_exons |> left_join(mane_transcripts |> filter(duplicated(ensembl_transcript_id) == FALSE), by = c("ensembl_gene_id", "ensembl_transcript_id", "chromosome_name", "strand"))
