...
populate_rsid_from_snp <- function() {
  ...
  file.copy(glue::glue('{ld_reference_panel_dir}/EUR/new_full.bed'), glue::glue('{ld_reference_panel_dir}/EUR/new_full_rsid.bed'))
  file.copy(glue::glue('{ld_reference_panel_dir}/EUR/new_full.fam'), glue::glue('{ld_reference_panel_dir}/EUR/new_full_rsid.fam'))
}
