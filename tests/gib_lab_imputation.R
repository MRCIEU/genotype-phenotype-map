weak_signal_example <- list(
  ld_matrix_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/12/103736758-105970320.unphased.vcor1.gz", # nolint: line_length_linter.
  ld_matrix_eig = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/12/103736758-105970320.ldeig.rds", # nolint: line_length_linter.
  ld_matrix_info_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/12/103736758-105970320.tsv", # nolint: line_length_linter.
  gwas_file = "/local-scratch/projects/genotype-phenotype-map/test/data/study/ebi-a-GCST90002304/standardised/EUR_12_104476236.tsv.gz" # nolint: line_length_linter.
)

strong_signal_example <- list(
  ld_matrix_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/2/45817500-46829710.unphased.vcor1.gz", # nolint: line_length_linter.
  ld_matrix_eig = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/2/45817500-46829710.ldeig.rds", # nolint: line_length_linter.
  ld_matrix_info_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/2/45817500-46829710.tsv", # nolint: line_length_linter.
  gwas_file = "/local-scratch/projects/genotype-phenotype-map/test/data/study/ebi-a-GCST90002304/standardised/EUR_2_46126027.tsv.gz" # nolint: line_length_linter.
)

complex_ld_region_example <- list(
  ld_matrix_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/6/31282730-32518958.unphased.vcor1.gz", # nolint: line_length_linter.
  ld_matrix_eig = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/6/31282730-32518958.ldeig.rds", # nolint: line_length_linter.
  ld_matrix_info_file = "/local-scratch/projects/genotype-phenotype-map/data/ld_reference_panel_hg38/EUR/6/31282730-32518958.tsv", # nolint: line_length_linter.
  gwas_file = "/local-scratch/projects/genotype-phenotype-map/test/data/study/ebi-a-GCST90002304/standardised/EUR_6_31344761.tsv.gz" # nolint: line_length_linter.
)
...
#' @param ss A data frame with columns betahat2 = vector of effect estimates in the same order as R and with NAs for variants that need to be imputed; se = as with betahat2 but for available standard errors, af = allele frequencies (no missing values allowed, so use reference panel if there are missing values) # nolint: line_length_linter.
#' @param index The positions of the SNPs that are causal and will be used to generate the simulated summary statistics. This can just be the top hit. # nolint: line_length_linter.
#'
...
#' - b_cor: The correlation between the true and imputed effect sizes - this is critical for evaluation of the performance of the imputation, it should be close to 1 e.g > 0.7 would be a reasonable threshold # nolint: line_length_linter.
