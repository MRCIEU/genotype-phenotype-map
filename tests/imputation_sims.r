...
sfile <- "/local-scratch/projects/genotype-phenotype-map/test/data/study/ebi-a-GCST90002304/standardised/EUR_9_32450189.tsv.gz"
...
sfile <- a[1]
sfile <- "/local-scratch/projects/genotype-phenotype-map/test/data/study/ebi-a-GCST90002304/standardised//EUR_3_169379112.tsv.gz"
